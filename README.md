...
Surge Relay 会将处理后的 Surge `.sgmodule` 文件发布到稳定的 GitHub 仓库地址，或保存到本地 iCloud Drive 目录。所有 iPhone、iPad、Apple TV 和 Mac 上的 Surge App 只需要订阅这些固定 URL。
...
<p align="center">
  ...
  <img width="375" alt="image" src="https://github.com/user-attachments/assets/d118a028-be85-4fff-b8a4-6b7da2dd5110" />
</p>
...
生成后的模块可以自动发布到 GitHub，或保存到 iCloud Drive。Mac 只负责构建和发布，用户设备读取的是已经发布好的稳定文件。因此，即使 Mac 关机或暂时无法连接，已经发布的模块仍然可以正常使用。
...
<p align="center">
  ...
  <img width="375" alt="Surge Relay Remote Management" src="https://github.com/user-attachments/assets/30bd4ee0-cfa5-4623-8d06-cc6a93a6a6e6" />
</p>
...
<p align="center">
  <img width="62%" alt="image" src="https://github.com/user-attachments/assets/72d84bb6-09e0-45aa-add1-e5c0baf1671f" />
